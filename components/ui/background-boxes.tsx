...
export const BoxesCore = ({ className, ...rest }: { className?: string }) => {
  ...
  return (
    <div
      style={{
        transform: `translate(-60%,-60%)  scale(0.675) rotate(0deg) translateZ(0)`,
      }}
      className={cn(
          ...
          {cols.map((_, j) => (
            <motion.div
              whileHover={{
                ...
                // backgroundImage: `url("@/public/next.svg")`,
              ...
              key={`col` + j}
              className="w-16 h-16  border-r border-t border-slate-200 relative pawdiv"
            >
              {j % 2 === 0 && i % 2 === 0 ? (
                <svg
